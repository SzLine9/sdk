 ...
 * @description 费用单
 */
class ReturnExpenseForm extends Sdk
{
    ...
    {
        return $this->request('post', '/erp-api/service/return_expense_form/list', $params, $headers, $options);
    }
    ...
    {
        return $this->request('post', '/erp-api/service/return_expense_form/detail', $params, $headers, $options);
    }
